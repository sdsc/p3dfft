...
# This script will generate a permutative batch job script on Edison.
#
...
batchf = open('jobs/edison_permutative.sh', 'w')
...
batchf.write('#PBS -l mppwidth=16\n')
...
for test in all_tests:
    ...
    for dims in all_dims:
        ...
        # run test
        batchf.write("aprun -n " + str(NUMCORES) + " " + basedir + "/" + test + "\n")
    # 1x1 dims test
    batchf.write("echo '1 1' > dims\n")
    batchf.write("aprun -n 1 " + basedir + "/" + test + "\n")
