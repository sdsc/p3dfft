...
# This script will generate a permutative batch job script on Comet for
...
batchf = open('jobs/comet_permutative-mt.sh', 'w')

# Write SBATCH header commands.
batchf.write('#!/bin/bash\n')
batchf.write('#SBATCH --job-name="p3dfft-mt"\n')
...
for test in all_tests:
    ...
    for dims in all_dims:
        ...
        # run test
        batchf.write("ibrun --npernode " + str(RANKSPERNODE) + " ../" + test + "\n")
    # 1x1 dims test
