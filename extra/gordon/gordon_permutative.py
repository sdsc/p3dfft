...
# This script will generate a permutative batch job script on Gordon.
#
...
for test in all_tests:
    ...
    for dims in all_dims:
        ...
        # run test
        batchf.write("ibrun -n " + str(NUMCORES) + " " + basedir + "/" + test + "\n")
    # 1x1 dims test
    batchf.write("echo '1 1' > dims\n")
    batchf.write("ibrun -n 1 " + basedir + "/" + test + "\n")
